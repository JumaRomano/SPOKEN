...
router.post('/', rbac('events', 'create'), auditLog('create', 'events'), eventController.create);
router.put('/:id', rbac('events', 'update'), auditLog('update', 'events'), eventController.update);
