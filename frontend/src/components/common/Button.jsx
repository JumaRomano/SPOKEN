...
const Button = ({
    ...
    const variants = {
        primary: 'bg-primary text-white hover:translate-y-[-2px] hover:shadow-lg hover:shadow-primary-light/40 disabled:hover:translate-y-0 disabled:hover:shadow-none',
    ...
    const resolvedVariants = {
        primary: 'bg-primary text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/40 focus:ring-primary',
